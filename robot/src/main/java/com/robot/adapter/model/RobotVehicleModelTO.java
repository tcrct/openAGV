...
public class RobotVehicleModelTO extends VehicleProcessModelTO {
    ...
    public RobotVehicleModelTO setSingleStepModeEnabled(boolean singleStepModeEnabled) {
    ...
    public RobotVehicleModelTO setLoadOperation(String loadOperation) {
    ...
    public RobotVehicleModelTO setUnloadOperation(String unloadOperation) {
    ...
    public RobotVehicleModelTO setOperatingTime(int operatingTime) {
    ...
    public RobotVehicleModelTO setMaxAcceleration(int maxAcceleration) {
    ...
    public RobotVehicleModelTO setMaxDeceleration(int maxDeceleration) {
    ...
    public RobotVehicleModelTO setMaxFwdVelocity(int maxFwdVelocity) {
    ...
    public RobotVehicleModelTO setMaxRevVelocity(int maxRevVelocity) {
    ...
    public RobotVehicleModelTO setVehiclePaused(boolean vehiclePaused) {
