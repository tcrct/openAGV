 ...
 * @author Laotang
 */
public class RobotCommAdapterPanel extends VehicleCommAdapterPanel {

    private final static Logger logger = LoggerFactory.getLogger(RobotCommAdapterPanel.class);

    private RobotVehicleModelTO robotVehicleModelTO;
    ...
    public void processModelChange(String attributeChanged, VehicleProcessModelTO newProcessModel) {
        if (!(robotVehicleModelTO instanceof RobotVehicleModelTO)) {
            return;
        }
        this.robotVehicleModelTO = (RobotVehicleModelTO) newProcessModel;
        updateVehicleModelData(attributeChanged, robotVehicleModelTO);
        updateVehicleProcessModelData(attributeChanged, robotVehicleModelTO);
    }
...
//        setName("CommAdapterPanel"); // NOI18N
        setName("RobotCommunicationAdapterPanel");
...
//        chkBoxEnable.setEnabled(false);
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("i18n/org/opentcs/commadapter/loopback/Bundle"); // NOI18N
...
//        getAccessibleContext().setAccessibleName(bundle.getString("loopbackCommAdapterPanel.accessibleName")); // NOI18N
    ...
    private void updateVehicleProcessModelData(String attributeChanged, RobotVehicleModelTO processModel) {
        if (Objects.equals(attributeChanged,
    ...
    private TCSObjectReference<Vehicle> getVehicleReference()
            throws Exception {
        return callWrapper.call(() -> vehicleService.fetchObject(Vehicle.class, robotVehicleModelTO.getVehicleName())).getReference();
    }
...
//            sendCommAdapterCommand(new com.openagv.opentcs.commands.TriggerCommand());
    ...
    private void chkBoxEnableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkBoxEnableActionPerformed
        try {
//            System.out.println("####################chkBoxEnableActionPerformed：" + robotVehicleModelTO.getVehicleName());
            Vehicle vehicle = callWrapper.call(() -> vehicleService.fetchObject(Vehicle.class, robotVehicleModelTO.getVehicleName()));
    ...
    private void precisePosTextAreaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_precisePosTextAreaMouseClicked
        if (precisePosTextArea.isEnabled()) {
            Triple pos = robotVehicleModelTO.getPrecisePosition();
    ...
    private void stateTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_stateTxtMouseClicked
        ...
        Vehicle.State currentState = robotVehicleModelTO.getVehicleState();
        // Create panel and dialog
...
//                .setLabel(BUNDLE.getString("loopbackCommAdapterPanel.label_state.text"))
    ...
    private void positionTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_positionTxtMouseClicked
        ...
        String currentPointName = robotVehicleModelTO.getVehiclePosition();
...
//                .setLabel(BUNDLE.getString("loopbackCommAdapterPanel.label_position.text"))
    ...
    private void orientationAngleTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_orientationAngleTxtMouseClicked
        ...
        double currentAngle = robotVehicleModelTO.getOrientationAngle();
        ...
        if (returnStatus == InputDialog.ReturnStatus.ACCEPTED) {
            ...
            if (input == null) {
                ...
                if (!Double.isNaN(robotVehicleModelTO.getOrientationAngle())) {
    ...
    private void dispatchEventButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dispatchEventButtonActionPerformed
        ...
        VehicleCommAdapterEvent event = new VehicleCommAdapterEvent(robotVehicleModelTO.getVehicleName(),
                appendix);
