...
public class DispatchFactory {
     ...
     */
    public static void onIncomingTelegram(Object telegramObj) {
        if (telegramObj instanceof IProtocol) {
            onIncomingTelegram((IProtocol) telegramObj);
        } else if (telegramObj instanceof String) {
            List<IProtocol> protocolList = RobotUtil.toProtocolList(String.valueOf(telegramObj));
