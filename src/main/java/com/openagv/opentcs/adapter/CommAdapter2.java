...
// * @author Laotang
// */
//public class CommAdapter2 extends BasicVehicleCommAdapter {
//
//    private static final Logger logger = Logger.getLogger(CommAdapter2.class);
//    // 组件工厂
...
//     */
//    private final static Map<String,String>  CUSTOM_ACTIONS_MAP = new ConcurrentHashMap<>();
//
//    /***
//     * 构造函数
//     * @param vehicle   车辆
...
//     */
//    @Inject
//    public CommAdapter2(@Assisted Vehicle vehicle, TCSObjectService objectService, ComponentsFactory componentsFactory) {
//        /**
...
//        Objects.requireNonNull(objectService, "objectService is null");
...
//        Objects.requireNonNull(telegramMatcher, "telegramMatcher is null");
...
//        // Update GUI.
//        synchronized (CommAdapter2.this) {
